...
def generate_launch_description():
    ...
    # Paths - using highway-style curved track
    world_file = os.path.join(pkg_vehicle_gazebo, 'worlds', 'highway_track.sdf')
    ...
    # Starting position adjusted for curved track
    ...
    spawn_vehicle = Node(
        ...
        arguments=[
            '-name', 'ackermann_car',
            '-file', vehicle_sdf,
            '-x', '-40',  # Start at beginning of highway track
            '-y', '0',
            '-z', '0.5'
        ],
        output='screen'
